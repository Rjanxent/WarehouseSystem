...
namespace warehouseManagement
{
    public partial class Login : Form
    {
        ...
        {
            // Implement label1 click functionality here
        }

        private void label2_Click(object sender, EventArgs e)
        {
            // Implement label2 click functionality here
        }

        private void pictureBox1_Click(object sender, EventArgs e)
        {
            // Implement pictureBox1 click functionality here
        }

        private void label3_Click(object sender, EventArgs e)
        {
            // Implement label3 click functionality here
        }

        private void pictureBox2_Click(object sender, EventArgs e)
        {
            // Implement pictureBox2 click functionality here
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            // Implement pictureBox3 click functionality here
        }
    }
}
